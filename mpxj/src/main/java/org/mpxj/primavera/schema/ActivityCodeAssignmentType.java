...
}) public class ActivityCodeAssignmentType
{
   ...
   @XmlElement(name = "ActivityCodeDescription") @XmlJavaTypeAdapter(Adapter1.class) protected String activityCodeDescription;
   @XmlElement(name = "ActivityCodeObjectId") protected Integer activityCodeObjectId;
   @XmlElement(name = "ActivityCodeTypeName") @XmlJavaTypeAdapter(Adapter1.class) protected String activityCodeTypeName;
   @XmlElement(name = "ActivityCodeTypeObjectId") protected Integer activityCodeTypeObjectId;
   @XmlElement(name = "ActivityCodeTypeScope") @XmlJavaTypeAdapter(Adapter1.class) protected String activityCodeTypeScope;
   @XmlElement(name = "ActivityCodeValue") @XmlJavaTypeAdapter(Adapter1.class) protected String activityCodeValue;
