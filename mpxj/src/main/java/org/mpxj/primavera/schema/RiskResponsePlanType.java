...
}) public class RiskResponsePlanType
{
   ...
   @XmlElement(name = "PlannedFinishDate", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter4.class) @XmlSchemaType(name = "dateTime") protected LocalDateTime plannedFinishDate;
   ...
   @XmlElement(name = "ResponseType") @XmlJavaTypeAdapter(Adapter1.class) protected String responseType;
